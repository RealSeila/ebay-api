...
sub setEnterpriseSeller {
  my $self = shift;
  $self->{'EnterpriseSeller'} = shift
}

=head2 isEnterpriseSeller()
...
sub isEnterpriseSeller {
  my $self = shift;
  return $self->{'EnterpriseSeller'};
}
