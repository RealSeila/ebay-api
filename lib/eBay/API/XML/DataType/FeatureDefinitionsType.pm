...
use eBay::API::XML::DataType::HandlingTimeEnabledDefinitionType;
...
use eBay::API::XML::DataType::PayPalRequiredForStoreOwnerDefinitionType;
...
use eBay::API::XML::DataType::ReturnPolicyEnabledDefinitionType;
use eBay::API::XML::DataType::RevisePriceAllowedDefinitionType;
use eBay::API::XML::DataType::ReviseQuantityAllowedDefinitionType;
...
use eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsDefinitionType;
use eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsEnabledDefinitionType;
...
my @gaProperties = ( [ 'AdFormatEnabled', 'ns:AdFormatEnabledDefinitionType', ''
	...
	, [ 'HandlingTimeEnabled', 'ns:HandlingTimeEnabledDefinitionType', ''
	     ,'eBay::API::XML::DataType::HandlingTimeEnabledDefinitionType', '1' ]
	...
	, [ 'PayPalRequiredForStoreOwner', 'ns:PayPalRequiredForStoreOwnerDefinitionType', ''
	     ,'eBay::API::XML::DataType::PayPalRequiredForStoreOwnerDefinitionType', '1' ]
	...
	, [ 'ReturnPolicyEnabled', 'ns:ReturnPolicyEnabledDefinitionType', ''
	     ,'eBay::API::XML::DataType::ReturnPolicyEnabledDefinitionType', '1' ]
	, [ 'RevisePriceAllowed', 'ns:RevisePriceAllowedDefinitionType', ''
	     ,'eBay::API::XML::DataType::RevisePriceAllowedDefinitionType', '1' ]
	, [ 'ReviseQuantityAllowed', 'ns:ReviseQuantityAllowedDefinitionType', ''
	     ,'eBay::API::XML::DataType::ReviseQuantityAllowedDefinitionType', '1' ]
	...
	, [ 'StoreOwnerExtendedListingDurations', 'ns:StoreOwnerExtendedListingDurationsDefinitionType', ''
	     ,'eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsDefinitionType', '1' ]
	, [ 'StoreOwnerExtendedListingDurationsEnabled', 'ns:StoreOwnerExtendedListingDurationsEnabledDefinitionType', ''
	     ,'eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsEnabledDefinitionType', '1' ]
...
#    Argument: 'ns:HandlingTimeEnabledDefinitionType'

=cut

sub setHandlingTimeEnabled {
  my $self = shift;
  $self->{'HandlingTimeEnabled'} = shift
}

=head2 getHandlingTimeEnabled()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:HandlingTimeEnabledDefinitionType'

=cut

sub getHandlingTimeEnabled {
  my $self = shift;
  return $self->_getDataTypeInstance( 'HandlingTimeEnabled'
		,'eBay::API::XML::DataType::HandlingTimeEnabledDefinitionType');
}
...
=head2 setPayPalRequiredForStoreOwner()
...
#    Argument: 'ns:PayPalRequiredForStoreOwnerDefinitionType'

=cut

sub setPayPalRequiredForStoreOwner {
  my $self = shift;
  $self->{'PayPalRequiredForStoreOwner'} = shift
}

=head2 getPayPalRequiredForStoreOwner()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:PayPalRequiredForStoreOwnerDefinitionType'

=cut

sub getPayPalRequiredForStoreOwner {
  my $self = shift;
  return $self->_getDataTypeInstance( 'PayPalRequiredForStoreOwner'
		,'eBay::API::XML::DataType::PayPalRequiredForStoreOwnerDefinitionType');
}
...
#    Argument: 'ns:ReturnPolicyEnabledDefinitionType'

=cut

sub setReturnPolicyEnabled {
  my $self = shift;
  $self->{'ReturnPolicyEnabled'} = shift
}

=head2 getReturnPolicyEnabled()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:ReturnPolicyEnabledDefinitionType'

=cut

sub getReturnPolicyEnabled {
  my $self = shift;
  return $self->_getDataTypeInstance( 'ReturnPolicyEnabled'
		,'eBay::API::XML::DataType::ReturnPolicyEnabledDefinitionType');
}


=head2 setRevisePriceAllowed()
...
#    Argument: 'ns:RevisePriceAllowedDefinitionType'

=cut

sub setRevisePriceAllowed {
  my $self = shift;
  $self->{'RevisePriceAllowed'} = shift
}

=head2 getRevisePriceAllowed()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:RevisePriceAllowedDefinitionType'

=cut

sub getRevisePriceAllowed {
  my $self = shift;
  return $self->_getDataTypeInstance( 'RevisePriceAllowed'
		,'eBay::API::XML::DataType::RevisePriceAllowedDefinitionType');
}


=head2 setReviseQuantityAllowed()
...
#    Argument: 'ns:ReviseQuantityAllowedDefinitionType'

=cut

sub setReviseQuantityAllowed {
  my $self = shift;
  $self->{'ReviseQuantityAllowed'} = shift
}

=head2 getReviseQuantityAllowed()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:ReviseQuantityAllowedDefinitionType'

=cut

sub getReviseQuantityAllowed {
  my $self = shift;
  return $self->_getDataTypeInstance( 'ReviseQuantityAllowed'
		,'eBay::API::XML::DataType::ReviseQuantityAllowedDefinitionType');
}
...
=head2 setStoreOwnerExtendedListingDurations()
...
#    Argument: 'ns:StoreOwnerExtendedListingDurationsDefinitionType'

=cut

sub setStoreOwnerExtendedListingDurations {
  my $self = shift;
  $self->{'StoreOwnerExtendedListingDurations'} = shift
}

=head2 getStoreOwnerExtendedListingDurations()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:StoreOwnerExtendedListingDurationsDefinitionType'

=cut

sub getStoreOwnerExtendedListingDurations {
  my $self = shift;
  return $self->_getDataTypeInstance( 'StoreOwnerExtendedListingDurations'
		,'eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsDefinitionType');
}


=head2 setStoreOwnerExtendedListingDurationsEnabled()
...
#    Argument: 'ns:StoreOwnerExtendedListingDurationsEnabledDefinitionType'

=cut

sub setStoreOwnerExtendedListingDurationsEnabled {
  my $self = shift;
  $self->{'StoreOwnerExtendedListingDurationsEnabled'} = shift
}

=head2 getStoreOwnerExtendedListingDurationsEnabled()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: none, ReturnSummary, ReturnAll

#    Returns: 'ns:StoreOwnerExtendedListingDurationsEnabledDefinitionType'

=cut

sub getStoreOwnerExtendedListingDurationsEnabled {
  my $self = shift;
  return $self->_getDataTypeInstance( 'StoreOwnerExtendedListingDurationsEnabled'
		,'eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsEnabledDefinitionType');
}
