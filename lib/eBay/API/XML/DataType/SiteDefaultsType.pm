...
use eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsType;
...
my @gaProperties = ( [ 'AdFormatEnabled', 'ns:AdFormatEnabledCodeType', ''
	...
	, [ 'HandlingTimeEnabled', 'xs:boolean', '', '', '' ]
	...
	, [ 'MaxFlatShippingCost', 'xs:boolean', '', '', '' ]
	, [ 'MaxFlatShippingCostCBTExempt', 'xs:boolean', '', '', '' ]
	...
	, [ 'PayPalRequiredForStoreOwner', 'xs:boolean', '', '', '' ]
	...
	, [ 'RegularSubscription', 'ns:GeographicExposureCodeType', ''
	     ,'eBay::API::XML::DataType::Enum::GeographicExposureCodeType', '' ]
	, [ 'ReturnPolicyEnabled', 'xs:boolean', '', '', '' ]
	, [ 'RevisePriceAllowed', 'xs:boolean', '', '', '' ]
	, [ 'ReviseQuantityAllowed', 'xs:boolean', '', '', '' ]
	...
	, [ 'StoreOwnerExtendedListingDurations', 'ns:StoreOwnerExtendedListingDurationsType', ''
	     ,'eBay::API::XML::DataType::StoreOwnerExtendedListingDurationsType', '1' ]
	, [ 'StoreOwnerExtendedListingDurationsEnabled', 'xs:boolean', '', '', '' ]
...
<br>
If false, a handling time is required,
and you need to specify a value for DispatchTimeMax in
AddItem (and VerifyAddItem).<br>
<br>
...
sub isHandlingTimeEnabled {
  my $self = shift;
  return $self->{'HandlingTimeEnabled'};
}
...
SeeLink: URL: http://developer.ebay.com/DevZone/XML/docs/WebHelp/index.htm?context=eBay_XML_API&topic=MaxFlatRateShippingCost
Title: Maximum Flat Rate Shipping Cost
DeprecationDetails: NoOp
DeprecationVersion: 583
UseInstead: 
#    Argument: 'xs:boolean'

=cut

sub setMaxFlatShippingCost {
  my $self = shift;
  $self->{'MaxFlatShippingCost'} = shift
}

=head2 isMaxFlatShippingCost()
...
sub isMaxFlatShippingCost {
  my $self = shift;
  return $self->{'MaxFlatShippingCost'};
}


=head2 setMaxFlatShippingCostCBTExempt()
...
sub setMaxFlatShippingCostCBTExempt {
  my $self = shift;
  $self->{'MaxFlatShippingCostCBTExempt'} = shift
}

=head2 isMaxFlatShippingCostCBTExempt()
...
sub isMaxFlatShippingCostCBTExempt {
  my $self = shift;
  return $self->{'MaxFlatShippingCostCBTExempt'};
}
...
=head2 isPayPalRequiredForStoreOwner()
...
sub isPayPalRequiredForStoreOwner {
  my $self = shift;
  return $self->{'PayPalRequiredForStoreOwner'};
}
...
sub isReturnPolicyEnabled {
  my $self = shift;
  return $self->{'ReturnPolicyEnabled'};
}
...
sub isRevisePriceAllowed {
  my $self = shift;
  return $self->{'RevisePriceAllowed'};
}
...
sub isReviseQuantityAllowed {
  my $self = shift;
  return $self->{'ReviseQuantityAllowed'};
}
...
#    Argument: 'ns:StoreOwnerExtendedListingDurationsType'
...
#    Returns: 'ns:StoreOwnerExtendedListingDurationsType'
...
=head2 isStoreOwnerExtendedListingDurationsEnabled()
...
sub isStoreOwnerExtendedListingDurationsEnabled {
  my $self = shift;
  return $self->{'StoreOwnerExtendedListingDurationsEnabled'};
}
