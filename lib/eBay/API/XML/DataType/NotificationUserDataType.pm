...
my @gaProperties = ( [ 'ExternalUserData', 'xs:string', '', '', '' ]
	, [ 'SMSSubscription', 'ns:SMSSubscriptionType', ''
...
sub setExternalUserData {
  my $self = shift;
  $self->{'ExternalUserData'} = shift
}

=head2 getExternalUserData()
...
sub getExternalUserData {
  my $self = shift;
  return $self->{'ExternalUserData'};
}
