...
package eBay::API::XML::DataType::ItemTransactionIDType;
...
eBay::API::XML::DataType::ItemTransactionIDType inherits from the L<eBay::API::XML::BaseDataType> class
