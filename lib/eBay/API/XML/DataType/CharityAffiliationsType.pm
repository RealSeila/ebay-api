...
package eBay::API::XML::DataType::CharityAffiliationsType;
...
# File: ................. CharityAffiliationsType.pm
...
eBay::API::XML::DataType::CharityAffiliationsType inherits from the L<eBay::API::XML::BaseDataType> class
...
use eBay::API::XML::DataType::CharityIDType;


my @gaProperties = ( [ 'CharityID', 'ns:CharityIDType', '1'
	     ,'eBay::API::XML::DataType::CharityIDType', '1' ]
                    );
...
sub getCharityID {
  my $self = shift;
  return $self->_getDataTypeArray('CharityID');
}
