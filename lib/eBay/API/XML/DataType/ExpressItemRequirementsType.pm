...
sub setNoDigitalDelivery {
  my $self = shift;
  $self->{'NoDigitalDelivery'} = shift
}

=head2 isNoDigitalDelivery()
...
sub isNoDigitalDelivery {
  my $self = shift;
  return $self->{'NoDigitalDelivery'};
}
