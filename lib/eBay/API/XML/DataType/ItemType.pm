...
use eBay::API::XML::DataType::DigitalDeliveryDetailsType;
use eBay::API::XML::DataType::DistanceType;
use eBay::API::XML::DataType::ExpressDetailsType;
...
my @gaProperties = ( [ 'ApplicationData', 'xs:string', '', '', '' ]
	...
	, [ 'DigitalDeliveryDetails', 'ns:DigitalDeliveryDetailsType', ''
	     ,'eBay::API::XML::DataType::DigitalDeliveryDetailsType', '1' ]
	, [ 'DisableBuyerRequirements', 'xs:boolean', '', '', '' ]
	, [ 'DispatchTimeMax', 'xs:int', '', '', '' ]
	, [ 'Distance', 'ns:DistanceType', ''
	     ,'eBay::API::XML::DataType::DistanceType', '1' ]
	, [ 'ExpressDetails', 'ns:ExpressDetailsType', ''
	     ,'eBay::API::XML::DataType::ExpressDetailsType', '1' ]
...
SeeLink: URL: io_GetSearchResultsExpress.html#Request.ItemDetails
Title: (GetSearchResultsExpress) ItemDetails
...
=head2 setDigitalDeliveryDetails()

As of March 2008, all digital listings on eBay US 
must be listed in a Classified Ad format, in the 
Information Product category (in the Everything Else category). 
Other sites do not support digital listings. If you use 
the DigitalDeliveryDetails field in AddItem and related calls, you 
...
#    Argument: 'ns:DigitalDeliveryDetailsType'

=cut

sub setDigitalDeliveryDetails {
  my $self = shift;
  $self->{'DigitalDeliveryDetails'} = shift
}

=head2 getDigitalDeliveryDetails()
...
#    Returns: 'ns:DigitalDeliveryDetailsType'

=cut

sub getDigitalDeliveryDetails {
  my $self = shift;
  return $self->_getDataTypeInstance( 'DigitalDeliveryDetails'
...
#    Argument: 'ns:ExpressDetailsType'

=cut

sub setExpressDetails {
  my $self = shift;
  $self->{'ExpressDetails'} = shift
}

=head2 getExpressDetails()
...
#    Returns: 'ns:ExpressDetailsType'

=cut

sub getExpressDetails {
  my $self = shift;
  return $self->_getDataTypeInstance( 'ExpressDetails'
...
, URL: io_GetUserPreferences.html#Response.ExpressPreferences
Title: (GetUserPreferences) ExpressPreferences
...
, URL: io_ReviseItem.html#Request.Item.ProductListingDetails
...
, URL: io_GetProducts.html#Response.Product.ItemSpecifics
...
SeeLink: URL: io_GetCategoryFeatures.html#Response.FeatureDefinitions.ListingDurations
...
, URL: io_GetCategoryFeatures.html#Response.FeatureDefinitions.ListingDurations
Title: GetCategoryFeatures
, URL: http://developer.ebay.com/DevZone/XML/docs/WebHelp/index.htm?context=eBay_XML_API&topic=FeesPerSite
Title: Fees per Site
...
=head2 getListingType()
  ...
  Returned: Conditionally
  AllValuesExcept: Unknown, Auction, Half
  Details: DetailLevel: none, ReturnSummary, ReturnAll, Shopping
  Context: ActiveList
           ScheduledList
           SoldList
           UnsoldList
...
, URL: io_SetUserPreferences.html#Request.SellerPaymentPreferences
Title: (SetUserPreferences) SellerPaymentPreferences
, URL: io_SetUserPreferences.html#Request.ExpressPreferences.DefaultPayPalAccount
...
, URL: io_RelistItem.html#Request.DeletedField
...
, URL: io_GetSearchResultsExpress.html#Request.ItemDetails
Title: (GetSearchResultsExpress) ItemDetails
...
, URL: io_GetItem.html#Response.Item.ShippingDetails.ThirdPartyCheckout
