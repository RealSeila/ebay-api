...
Moneybookers Payment option. It is one of the Safe Electronic Payment Methods.
...
use constant Moneybookers => scalar('Moneybookers');


=head2 allpay

AllPay Payment option. It is one of the Safe Electronic Payment Methods.
...
use constant allpay => scalar('allpay');


=head2 ProPay

ProPay Payment option. It is one of the Safe Electronic Payment Methods.
...
use constant ProPay => scalar('ProPay');


=head2 PayOnPickup

PayOnPickup Payment option. US will support Cash On Pickup (COP) . In the frontend COP is renamed to Pay On Pickup
...
use constant PayOnPickup => scalar('PayOnPickup');
