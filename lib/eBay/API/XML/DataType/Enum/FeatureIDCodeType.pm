...
=head2 PayPalRequiredForStoreOwner

(in) Defines if PayPal is required for Store Owners on fixed price listings (FixedPriceItem and StoresFixedPrice).
...
use constant PayPalRequiredForStoreOwner => scalar('PayPalRequiredForStoreOwner');


=head2 ReviseQuantityAllowed

(in) Defines if quantity can be revised while a listing is in semi or fully restricted mode.
...
use constant ReviseQuantityAllowed => scalar('ReviseQuantityAllowed');


=head2 RevisePriceAllowed

(in) Defines if price can be revised while a listing is in semi or fully restricted mode.
...
use constant RevisePriceAllowed => scalar('RevisePriceAllowed');


=head2 StoreOwnerExtendedListingDurationsEnabled

(in) Defines if extended store owner listing durations are enabled on fixed price listings (FixedPriceItem and StoreFormatItems).
...
use constant StoreOwnerExtendedListingDurationsEnabled => scalar('StoreOwnerExtendedListingDurationsEnabled');


=head2 StoreOwnerExtendedListingDurations

(in) Provides additional listing durations that are supported by store owners.
...
use constant StoreOwnerExtendedListingDurations => scalar('StoreOwnerExtendedListingDurations');


=head2 ReturnPolicyEnabled

(in) Defines if listings require a return policy.
...
use constant ReturnPolicyEnabled => scalar('ReturnPolicyEnabled');


=head2 HandlingTimeEnabled

(in) Defines if listings require a handling time (dispatch time).
...
use constant HandlingTimeEnabled => scalar('HandlingTimeEnabled');
