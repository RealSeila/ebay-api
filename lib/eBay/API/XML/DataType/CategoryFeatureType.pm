...
If false, listings in this category require a handling time (dispatch time).
...
If true, listings in this category require a return policy.
Returned only if this category overrides the site default.
