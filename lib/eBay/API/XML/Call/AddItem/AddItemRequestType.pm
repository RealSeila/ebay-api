...
package eBay::API::XML::Call::AddItem::AddItemRequestType;
...
eBay::API::XML::Call::AddItem::AddItemRequestType inherits from the L<eBay::API::XML::RequestDataType> class
