...
use eBay::API::XML::DataType::ReturnPolicyDetailsType;
...
my @gaProperties = ( [ 'CountryDetails', 'ns:CountryDetailsType', '1'
	...
	, [ 'ReturnPolicyDetails', 'ns:ReturnPolicyDetailsType', ''
	     ,'eBay::API::XML::DataType::ReturnPolicyDetailsType', '1' ]
...
=head2 setReturnPolicyDetails()

gives details about the returnpolicy related attributes .

#    Argument: 'ns:ReturnPolicyDetailsType'

=cut

sub setReturnPolicyDetails {
  my $self = shift;
  $self->{'ReturnPolicyDetails'} = shift
}
...
sub getReturnPolicyDetails {
  my $self = shift;
  return $self->_getDataTypeInstance( 'ReturnPolicyDetails'
