...
use eBay::API::XML::DataType::ExpressSellerRequirementsType;
...
my @gaProperties = ( [ 'AllowPaymentEdit', 'xs:boolean', '', '', '' ]
	...
	, [ 'ExpressEligible', 'xs:boolean', '', '', '' ]
	, [ 'ExpressSellerRequirements', 'ns:ExpressSellerRequirementsType', ''
	     ,'eBay::API::XML::DataType::ExpressSellerRequirementsType', '1' ]
	, [ 'ExpressWallet', 'xs:boolean', '', '', '' ]
...
and examining the fields in the ExpressSellerRequirements node.
<p></p>
...
sub setExpressEligible {
  my $self = shift;
  $self->{'ExpressEligible'} = shift
}

=head2 isExpressEligible()
...
sub isExpressEligible {
  my $self = shift;
  return $self->{'ExpressEligible'};
}


=head2 setExpressSellerRequirements()
...
#    Argument: 'ns:ExpressSellerRequirementsType'

=cut

sub setExpressSellerRequirements {
  my $self = shift;
  $self->{'ExpressSellerRequirements'} = shift
}

=head2 getExpressSellerRequirements()
...
#    Returns: 'ns:ExpressSellerRequirementsType'

=cut

sub getExpressSellerRequirements {
  my $self = shift;
  return $self->_getDataTypeInstance( 'ExpressSellerRequirements'
		,'eBay::API::XML::DataType::ExpressSellerRequirementsType');
}


=head2 setExpressWallet()
...
sub setExpressWallet {
  my $self = shift;
  $self->{'ExpressWallet'} = shift
}

=head2 isExpressWallet()
