...
use eBay::API::XML::DataType::Enum::DigitalDeliveryEnabledCodeType;
...
my @gaProperties = ( [ 'AdFormatEnabled', 'ns:AdFormatEnabledCodeType', ''
	...
	, [ 'DigitalDeliveryEnabled', 'ns:DigitalDeliveryEnabledCodeType', ''
...
Specifies the default site setting for whether categories allow
counter offers for Best Offers. True means counter offers are allowed site-wide, unless a specific category overrides the setting.
...
=head2 setDigitalDeliveryEnabled()
...
#    Argument: 'ns:DigitalDeliveryEnabledCodeType'

=cut

sub setDigitalDeliveryEnabled {
  my $self = shift;
  $self->{'DigitalDeliveryEnabled'} = shift
}

=head2 getDigitalDeliveryEnabled()

  Calls: GetCategoryFeatures
  Returned: Conditionally
  Details: DetailLevel: ReturnAll

#    Returns: 'ns:DigitalDeliveryEnabledCodeType'

=cut

sub getDigitalDeliveryEnabled {
  my $self = shift;
  return $self->{'DigitalDeliveryEnabled'};
}
...
unless a specific category overrides the setting. This element is for Local Market dealers.
...
Specifies the default site setting for whether most categories allow seller-level contact information for Classified Ad format listings. A value of true
...
Specifies the default site setting for whether categories allow
the Store Inventory Format feature. True means the feature is allowed site-wide, unless a specific category overrides the setting.
