...
package eBay::API::XML::DataType::PayPalRequiredDefinitionType;
...
# File: ................. PayPalRequiredDefinitionType.pm
...
eBay::API::XML::DataType::PayPalRequiredDefinitionType inherits from the L<eBay::API::XML::BaseDataType> class
