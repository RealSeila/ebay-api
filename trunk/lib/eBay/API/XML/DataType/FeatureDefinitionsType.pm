...
use eBay::API::XML::DataType::DigitalDeliveryEnabledDefinitionType;
...
my @gaProperties = ( [ 'AdFormatEnabled', 'ns:AdFormatEnabledDefinitionType', ''
	...
	, [ 'DigitalDeliveryEnabled', 'ns:DigitalDeliveryEnabledDefinitionType', ''
	     ,'eBay::API::XML::DataType::DigitalDeliveryEnabledDefinitionType', '1' ]
...
#    Argument: 'ns:DigitalDeliveryEnabledDefinitionType'
...
#    Returns: 'ns:DigitalDeliveryEnabledDefinitionType'

=cut

sub getDigitalDeliveryEnabled {
  my $self = shift;
  return $self->_getDataTypeInstance( 'DigitalDeliveryEnabled'
